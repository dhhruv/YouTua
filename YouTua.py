...
class MainWindow:
    ...
    def __init__(self, root):
        ...
        self.format_menu = OptionMenu(root, self.vid_format,
                *self.formats)
        self.format_menu.configure(background='white',
        ...
        self.quality_menu = OptionMenu(root, self.quality,
                *self.OPTIONS)
        self.quality_menu.configure(background='white',
                                    activebackground='white')
...
6. Click START DOWNLOAD and enjoy.""")
    ...
    def show_about(self):
        messagebox.showinfo('YouTua v2.0.0',
